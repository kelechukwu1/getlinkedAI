...
const NavBar = () => {
	...
	return (
		<>
			<header>
				<div className="items-center justify-between shadow md:flex md:p-5 bg-custom-color">
					<div className="items-center w-full p-5 lg:px-24 md:p-0 md:flex md:justify-between">
						...
						<div className="hidden w-full text-white transition-all duration-500 ease-in md:flex md:items-center md:pb-0 md:z-auto md:justify-end">
								...
								<div className="md:flex">
									{navLinks.map(({ link, name }) => (
										<Link
											href={link}
											key={name}
											className="mx-2 text-center font-semibold"
										>
											<div
												className={`md:px-4 my-5 md:my-0 ${
													(pathname === link && link === "contact") ||
													(pathname === "/contact" && link === "contact") ||
													(pathname === "/register" && link === "contact")
														? "bg-gradient-to-r from-purple-400 to-pink-600 inline-block text-transparent bg-clip-text"
														: ""
												}`}
											>
												{name}
					...
					>
						<div className="flex w-full h-screen bg-custom-color">
							<div className="absolute p-4 top-5 right-1">
							...
							<div
								...
								className="w-full py-24 mx-5 my-5 space-y-5 text-white transition-all duration-500"
							>
								{navLinks.map(({ link, name }) => (
									<Link
										href={link}
