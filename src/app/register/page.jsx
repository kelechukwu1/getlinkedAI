...
import graphicsDesginer from "../../../public/3d-graphic-designer.png";
                ...
                <div className="flex flex-col gap-5 md:gap-3 md:grid grid-cols-2 grid-rows-2">
                  <div className="space-y-2 col-span-1">
                    ...
                    <input
                      ...
                      className="w-full h-[47px] rounded-md pl-7 md:pl-2 border-2 border-[rgba(255, 255, 255, 1)] bg-transparent drop-shadow-[0px_4px_4px_0px rgba(0, 0, 0, 0.25)] text-white md:placeholder:text-xs lg:placeholder:text-base"
                    />
                  </div>
